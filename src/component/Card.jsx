...
function Card({
  ...
  return (
    <div onClick={onCardClick}
      className={`hover:scale-110 hover:cursor-pointer transition-all ease-out duration-600 border-b-8 ${borderColor} w-64  ${background} rounded-md flex flex-col justify-center items-center py-2`}
    >
